...
INSERT INTO `auteur` (`id_auteur`, `nom`, `prenom`, `nationalité`) VALUES
(1, 'Homère', 'Homère', 'grecque'),
(2, 'Shakespeare', 'William', 'anglais'),
(3, 'Sophocle', 'Sophocle', 'grec'),
...
(4, 2, 'Le petit prince', 'enfant', 'uploads/petitprince.jpg'),
(6, 2, 'Harry potter', 'science fiction', ''),
...
(20, 1, 'Odyssée', 'épopée', ''),
(21, 3, 'Iliade', 'épopée', 'uploads/grece1.jpg'),
(22, 2, 'saturne', 'astronomie', 'uploads/saturne.jpg'),
(23, 1, 'hello', 'astronomie', 'uploads/amiral.png'),
(24, 3, 'hello', 'astronomie', 'uploads/or.jpg'),
(26, 3, 'Kheang', 'Fantastique', 'uploads/automne.jpg'),
(28, 1, 'saturne', 'test', 'uploads/or.jpg'),
(29, 7, 'Nestor', 'toto', 'uploads/or.jpg'),
(30, 7, 'papillon', 'science', 'uploads/amiral.png'),
...
INSERT INTO `publier` (`date_publication`, `id_livre`, `id_auteur`, `id_editeur`, `id_publier`) VALUES
('2020-07-01', 4, 12, 5, 15);
...
(6, 'juju5M', 'juju@yahoo.fr', 30, 'homme', 'france', 'jujumdp', 'administrateur'),
(7, 'juju', 'juju@yahoo.fr', 30, 'homme', 'france', 'jujumdp', 'administrateur'),
(8, 'juju2', 'juju@yahoo.fr', 30, 'homme', 'france', 'jujumdp', 'administrateur');
...
--
ALTER TABLE `editeur`
  MODIFY `id_editeur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `livre`
  MODIFY `id_livre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT pour la table `publier`
--
ALTER TABLE `publier`
  MODIFY `id_publier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
